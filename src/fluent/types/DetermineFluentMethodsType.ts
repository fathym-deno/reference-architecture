 ...
 * ```
 */
export type DetermineFluentMethodsType<T> = T extends infer U
  ? $FluentTagExtract<U, 'Methods'> extends [never]
    ? DetermineDefaultFluentMethodsType<U>
    : $FluentTagExtract<U, 'Methods'>
  : never;
