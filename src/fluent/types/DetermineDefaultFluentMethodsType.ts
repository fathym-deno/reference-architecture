 ...
 * ```
 */
// export type _DetermineDefaultFluentMethodsType<
//   T,
//   K extends keyof T,
...
//   : never
//   : T;
export type DetermineDefaultFluentMethodsType<T> = T extends infer U
  ? NoPropertiesUndefined<U> extends infer V
    ? false extends IsObjectNotNative<V>
      ? DetermineDefaultNonObjectFluentMethodsType<V>
      : DetermineDefaultObjectFluentMethodsType<V>
    : never
  : never;
...
export type DetermineDefaultNonObjectFluentMethodsType<T> = ExtractExact<
...
export type DetermineDefaultObjectFluentMethodsType<T> = $FluentTagExtract<
  T,
  'Methods'
> extends [never]
  ? false extends IsFluentRecord<T>
    ? DetermineDefaultNonRecordFluentMethodsType<T>
    : DetermineDefaultRecordFluentMethodsType<T>
...
export type DetermineDefaultNonRecordFluentMethodsType<T> = ExtractExact<
  $FluentTagMethodsOptions,
  'Object'
>;
...
export type DetermineDefaultRecordFluentMethodsType<T> = ExtractExact<
  $FluentTagMethodsOptions,
  'Record'
>;
